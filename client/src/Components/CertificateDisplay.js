...
const DetailGroup = (props) => {
  return (
    <>
      <Box>
        <Box fontSize={16} fontWeight={500} color="#04add9">
          {props.label}
        </Box>
        <Box m={1} />
  ...
  return (
    <>
      <Paper id="back" className={classes.paper}>
        <Grid container>
          <Grid container>
            <Grid item xs={12} className={classes.certHeader}></Grid>
            <Grid item xs={12} className={classes.certTopSection}></Grid>
            <Grid item xs={12} className={classes.certTopSection}></Grid>
            <Grid item xs={12} className={classes.certTopSection}></Grid>
            <Grid item xs={12} className={classes.certTopSection}></Grid>
            <Grid item xs={12} className={classes.certTopSection}>
              ...
              >
                <Grid item></Grid>
                <Grid item>
                  <DetailGroup label="" content={candidateName} />
                </Grid>
                <Grid item>
            ...
            <Grid item xs={12} className={classes.certMidSection}>
              <Grid container justifyContent="space-around" >
                ...
                <Grid item xs={2}>
                  <DetailGroup label="" content={courseName} />
                </Grid>
                <Grid item xs={2}>
                  <DetailGroup label="" content={instituteName} />
                </Grid>
